...
def create_border(x_0, y_0, x_fin, y_fin, step, border_vertexes, border_lines):
...
create_border(x_0, y_0, x_fin, y_fin, step, border_vertexes, border_lines)
...
triangle_border_vertexes = list()
triangle_border_lines = list()
